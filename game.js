...
var bird = {
    ...
    update:function(){
        let priod = state.current == state.getReady ? 10 : 5;
        this.animationIndex += frames%priod == 0 ? 1 : 0;
        ...
        if (state.current == state.getReady) {
            ...
            if (this.speed < this.jump) {
                ...
                this.rotation = 270 * degree;
            }
        }
        if (this.y + this.h/2 >= cvs.height - fg.h) {
            this.y = cvs.height - fg.h - bird.h/2;
